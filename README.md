...
- [📋 Notion for Project Management](#notion-link)
- [🎨 Figma for Design](#figma-link)

## 🗂 Repositories
- [Backend Repository](#backend-repo-link) - Contains details on the Node.js and MongoDB setup as well as Python scripts using LangChain.
- [Frontend Repository](#frontend-repo-link) - Contains details on the React implementation.
